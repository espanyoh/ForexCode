...
void CheckForMaTrade(){
   ...
   checkToClose(PreviousFast, CurrentFast, PreviousSlow, CurrentSlow);
  
  
   
   if(PreviousFast<PreviousSlow && CurrentFast>CurrentSlow
      && CurrentFast-PreviousSlow > threshold*pips
      && iClose(NULL, 0, 1) - iOpen(NULL, 0, 1) > 0)
      OrderEntry(0);
   if(PreviousFast>PreviousSlow && CurrentFast<CurrentSlow
...
void  checkToClose(string PreviousFast, string CurrentFast, string PreviousSlow, string CurrentSlow){
   //Buy Order section
