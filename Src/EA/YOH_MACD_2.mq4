...
extern double    Lots=0.1;  // number of lots to trade (usually, 1 lot is $100k) (unlimited)
extern double     TrailingStop=55;   // the amount of the trailing stop needed to maximize profit (unlimited)
extern int MACD_level=25; //(1-12) [low works for GBPUSD], high works for others.
